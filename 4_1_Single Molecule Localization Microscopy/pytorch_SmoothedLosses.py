...
class torch_loss_cHM(torch.autograd.Function):
    """
    ...
    @staticmethod
    def forward(ctx, location_pred, location_true, smoothing_lambda=0.2):
        """
        ...
        ctx.smoothing_lambda = smoothing_lambda
    ...
    def backward(ctx, grad):
        ...
        smoothing_lambda = ctx.smoothing_lambda
...
def CountingLoss(pred, targets, threshold=0):
    ...
    return -torch.sum(torch.log(count_prediction + 1e-12) * target_distribution)
